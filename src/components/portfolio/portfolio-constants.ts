...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'Advanced mortgage brokerage platform with AI-powered client matching and deal optimization.',
    type: 'webapp',
    category: 'business',
  ...
  },
  {
    ...
    description: 'Comprehensive social media management and analytics platform with AI-driven content optimization.',
    type: 'webapp',
    category: 'business',
  ...
  },
  {
    ...
    description: 'Streamlined recruitment workflow management system with automated timesheet and contractor tracking.',
    type: 'webapp',
    category: 'business',
