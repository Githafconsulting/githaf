        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="order-2 lg:order-1 reveal">
            <div className="relative">
              <div className="absolute -top-4 -left-4 w-24 sm:w-32 h-24 sm:h-32 bg-primary/10 rounded-xl -z-10"></div>
              <div className="absolute -bottom-4 -right-4 w-24 sm:w-32 h-24 sm:h-32 bg-accent/10 rounded-xl -z-10"></div>
