...
${formData.message || 'None provided'}
      ...
      // Save booking details for confirmation screen
      setBookingDetails({
        name: formData.name,
        email: formData.email,
        date: formattedDate,
      ...
      // Reset form and show confirmation screen
  ...
  // If booking is complete, show confirmation screen
  if (bookingComplete && bookingDetails) {
    return <BookingConfirmation details={bookingDetails} onReset={() => setBookingComplete(false)} />;
  }
