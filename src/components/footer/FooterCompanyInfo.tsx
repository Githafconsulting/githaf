    ...
    <div className="enhanced-card p-6">
      ...
      <div className="glass rounded-lg p-4">
        <div className="flex items-center gap-2 mb-2">
          <div className="w-2 h-2 bg-gradient-to-r from-slate-400 to-slate-500 rounded-full animate-pulse"></div>
          <span className="text-gray-300 text-sm">Ready to transform your business?</span>
        </div>
      </div>
    </div>
  );
